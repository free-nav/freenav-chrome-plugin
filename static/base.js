$(document).ready(function(){
	...
	const api_category_list = localStorage.getItem('api_url') + '/index.php?c=api&method=category_list';
	...
	$("#add_link").click(function(){
		...
		$.post(api_add_link,{token:api_token,url:url,title:title,fid:fid,description:description,property:property},function(data,status){
			if( data.code == 0 ) {
